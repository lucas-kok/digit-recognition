...
# Save the model
np.savetxt('model/digits/Theta1.txt', optimized_Theta1, delimiter=' ')
np.savetxt('model/digits/Theta2.txt', optimized_Theta2, delimiter=' ')
np.savetxt('model/digits/Theta3.txt', optimized_Theta3, delimiter=' ')
